  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ai: "bg-gradient-hero text-primary-foreground hover:shadow-glow border border-primary-glow/30 relative overflow-hidden",
        process: "bg-card text-card-foreground border border-border hover:shadow-elegant hover:border-primary/30 transition-all",
        workflow: "bg-accent text-accent-foreground hover:bg-accent/80 border border-accent-foreground/20"
      },
      size: {
