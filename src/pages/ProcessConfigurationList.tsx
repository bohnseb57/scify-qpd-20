  ...
  return <div className="bg-gradient-subtle min-h-full">
      <div className="border-b bg-background/95 backdrop-blur">
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-foreground">Quality Process Configuration</h1>
              <p className="text-muted-foreground">Manage and configure your quality processes</p>
            </div>
            <Button onClick={() => navigate('/create-process')} className="bg-gradient-primary hover:bg-primary-hover transition-smooth">
      ...
      <div className="p-6 space-y-8">
        <Card className="shadow-elegant">
          ...
          <CardContent>
            {processes.length === 0 ? <div className="text-center py-12">
